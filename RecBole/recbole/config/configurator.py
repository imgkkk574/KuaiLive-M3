...
class Config(object):
    ...
    def _init_device(self):
        ...
        # Note: original RecBole code overwrites CUDA_VISIBLE_DEVICES here from
        # gpu_id, which breaks external GPU allocation. Removed — set the env
        # var at shell level before launching Python instead.
