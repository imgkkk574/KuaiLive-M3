...
# Output (highlight_data/, highlight_ckpt_next1/) is produced under highlight/.
#
# Usage (same as highlight/run_highlight.sh):
#   bash run_highlight.sh <klm3_data_dir> <gpu_list> [extra_args...]
#
# Examples:
#   bash run_highlight.sh /data/klm3 0,1,2,3                    # all 3 variants
#   VARIANTS="plain" bash run_highlight.sh /data/klm3 0,1,2,3  # embedding only
